...
*/
    ...
    */
    function cueVideoInPlayer() {
        
        //if the index position
        //of the 'karaoke-slider li.active' element
        //is NOT EQUAL to
        //the number of
        //karaoke-slider li items
        if (currentActivSliderItm.data('length_position') != $('#karaoke-slider li').length) {
            //set the var nextActivSliderItm
            //as the karaoke-slider li item
            //directly coming after
            //the present 'karaoke-slider li.active' item
            ...
            //a transition of
            //active items
            //in the karaoke-slider unordered list,
            //the karaokedesclist unordered list,
            //and the videos datatable
        ...
        //karaoke-slider li items
            ...
            //set the var nextActivSliderItm
            //as the first karaoke-slider li item
        ...
        //the 'videoIdToCue' variable
        //is assigned a value
        //and this new video ID is cued
    ...
    * when the YouTube Iframe player
    ...
    function onPlayerReady(event) { 
        ...
        */
        $('#karaoke-slider li .video-thumbnail-play-icon-overlay').click(function () {
            ...
            //if the 'videoCueTimeout'
            //window.setTimeout object is set,
            //clear it
            clearVideoCueTimeout(videoCueTimeout);    
    ...
    */
    function onPlayerStateChange(event) {
        ...
        if (event.data === 5) { //if the video has been cued
            ...
            //when the 'showinfo' button
            //or the 'hideinfo' button is clicked
            //clear the 'videoCueTimeout'
            //window.setTimeout object
            //if it is set
            $('#info-buttons ul li#showinfo').click(function () {
                clearVideoCueTimeout(videoCueTimeout);       
            });
            $('#info-buttons ul li#hideinfo').click(function () {
                clearVideoCueTimeout(videoCueTimeout);
            });
            
            //invoke the 'cueVideoInPlayer' function
            //every 7 seconds,
            //thereby switching the
            //video on cue in the yt-player
            //every 7 seconds
            videoCueTimeout = window.setTimeout(cueVideoInPlayer, 7000);
        }
        ...
        if (event.data === 1) { //if the video is playing
            ...
            //window.setTimeout object is set,
            //clear it so that
            //the video won't change to
            //another in 7 seconds
            clearVideoCueTimeout(videoCueTimeout);
