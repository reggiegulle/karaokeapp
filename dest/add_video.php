            ...
            <section id="user_panel_normal" class="user_panel col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
                ...
                <form id="addnewvideo" action="" method="POST">
                    ...
                    <div class="field">
                        ...
                        <input type="text" id="year_of_release" class="col-xs-3 col-sm-2" name="year_of_release" form="addnewvideo" value="<?php if(!Session::exists('add_video')){ echo html_entity_decode(Input::get('year_of_release')); }  ?>" />
                    </div>
                    <div class="field">
                        <article class="col-xs-12 feedback-notif">
                            <?php
                    ...
                    <div class="field">
                        ...
                        <div class="col-xs-12">
                            ...
                            <br />
                            <input type="text" id="running_time_min" name="running_time_min" form="addnewvideo" value="<?php if(!Session::exists('add_video')){ echo html_entity_decode(Input::get('running_time_min')); }  ?>" /> <span class="time-input">min</span>
                            <input type="text" id="running_time_sec" name="running_time_sec" form="addnewvideo" value="<?php if(!Session::exists('add_video')){ echo html_entity_decode(Input::get('running_time_sec')); }  ?>" /> <span class="time-input">sec</span>
                        </div>  
                    </div>
                    <div class="field">
                        <article class="col-xs-12 feedback-notif">
