$(document).ready(function(){
	...
	function placeEditors() {
		$("#users_datatable tbody tr").each( function () {
			...
			var userdata = users_datatable.cell(this, 0).data();
			var usernode = users_datatable.cell(this, 1).node();
			var usercol = $(usernode)
				.html('<p>' + userdata + '</p><a href="edit_user.php?id=' + userdata + '"><p>Edit User Details</p></a><a href="delete_user.php?id=' + userdata + '" onclick="return confirm(\'Are You Sure?\')"><p>Delete User</p></a>');
		});
	}
